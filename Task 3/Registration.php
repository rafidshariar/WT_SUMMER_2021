<?php   include "Control\myfrom.php" ; ?>
<html lang="en">
<!DOCTYPE html>
<html>
<head>
...
<tr>
<td>Comment :</td>
<td><textarea cols="30" rows="5" name="comment"></textarea> <?php echo $validatecomment; ?></td>
</tr>
<tr>
<td> Gender : </td>
<td>
...
<td>:<input type="file" id="file"  name="image" Required> <?php  echo  $validImage;    ?></td></tr>
<tr>
