<?php
    include '../../controllers/deliveryGuyController.php';
...
<html>
    <head>
        <title>Delivery Guy Registration</title>
    ...
    <?php
            ...
            if(isset($_POST['submit']))
            {
                ...
                if(!$has_error)
		        {
                    ...
                    insertDeliGuy($c_id, $fname, $phoneNumber, $email, $address1, '29', $dob, $gender, 'active');
                    
                    accessUser($c_id, $pass, 'deliveryGuy', $ans, 'active');
