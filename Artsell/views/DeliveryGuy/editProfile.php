...
<?php
            ...
            if(isset($_POST['submit']))
            {
                ...
                if(!$has_error)
		        {
                    ...
                    editDeliGuy($aid, $mobile, $email, $address);
			...
			<form method="post" action="" enctype="multipart/form-data">
                <table>                 
                    <tbody>
                        ...
                        <tr>
                            <td>Mobile</td>
                            <td><input type="text" name="mobile" value="<?php echo $deliguy["mobile"];?>"></td>
                            <td><span style="color:red"><?php echo $err_mobile?></span></td>
                        </tr>
                        <tr>
                            <td>Address: </td>
                            <td><input type="text" name="address" value="<?php echo $deliguy["address"];?>"></td>
                        ...
                        <tr>
                            <td>Email: </td>
                            <td><input type="text" name="email" value="<?php echo $deliguy["email"];?>"></td>
